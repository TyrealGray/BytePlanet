    ...
    var each = helpers.each = function (loopable, callback, self) {
        ...
        retinaScale = helpers.retinaScale = function (chart) {
            ...
            if (window.devicePixelRatio) {
                ctx.canvas.style.width = ctx.canvas.style.width ? ctx.canvas.style.width : (width + "px");
                ctx.canvas.style.height = height + "px"; //ctx.canvas.style.height ? ctx.canvas.style.height : (height + "px");
